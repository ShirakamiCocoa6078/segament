// 파일 경로: src/app/[userId]/dashboard/detail/maimai/[slug]/page.tsx
'use client';
...
export default function UserMaimaiDetailPage() {
    ...
    const fetchProfile = async () => {
      ...
      try {
        ...
        const endpoint = isOwner 
          ? `/api/dashboard/detail?gameType=MAIMAI&region=${region}`
          : `/api/profile/detail/${userId}?gameType=MAIMAI&region=${region}`;
