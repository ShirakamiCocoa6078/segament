// 파일 경로: src/app/dashboard/detail/maimai/playPercent/page.tsx
'use client';
...
export default function MaimaiPlayPercentPage() {
    ...
    const fetchPlayPercent = async () => {
      try {
        ...
        const mockData: PlayPercentData = {
          ...
          percentage: 41.3,
          difficultyBreakdown: {
            BASIC: { total: 920, played: 720, percentage: 78.3 },
            ADVANCED: { total: 920, played: 480, percentage: 52.2 },
            EXPERT: { total: 920, played: 320, percentage: 34.8 },
            MASTER: { total: 780, played: 180, percentage: 23.1 },
            REMASTER: { total: 380, played: 85, percentage: 22.4 },
          },
        };
  ...
  const difficultyColors = {
    ...
    REMASTER: 'bg-pink-500',
  };

  return (
    <div className="container mx-auto p-6 space-y-6">
      <h1 className="text-3xl font-bold">maimai 순회 진행도</h1>
